    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center justify-between gap-4">
          ...
          <ToggleGroup type="single" variant="outline" size="sm" spacing={0} value={activeView} onValueChange={(v) => { if (v) setActiveView(v as FileManagerView); }} aria-label="File view">
